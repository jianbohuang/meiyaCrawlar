...
# import pymysql
# try:
#     conn=pymysql.connect(host='localhost',user='root',passwd='123456',db='dianping',charset="utf8")
# except Exception ,e:
#     print e
#     sys.exit()
#
# cur = conn.cursor()
# try:
#     cur.execute("insert into pages (title ,content) values ('中文', '北京')")
#     # cur.connection.commit()
#     cur.execute("select * from pages ") #返回 tuple类型数组
# except Exception,e:
#     print e
#
# one=cur.fetchall()
# print one[3][1].decode(),len(one)
# cur.close()
# conn.close()
# s = "你好"
# print(s.decode())
